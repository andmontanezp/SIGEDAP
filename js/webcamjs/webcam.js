...
window.webcam = {
	...
	swf_url: 'http://192.168.10.103/SIGEDAP/js/webcamjs/webcam.swf', // URI to webcam.swf movie (defaults to cwd)
	shutter_url: 'http://192.168.10.103/SIGEDAP/js/webcamjs/shutter.mp3', // URI to shutter.mp3 sound
	api_url: 'http://192.168.10.103/SIGEDAP/js/webcamjs/test.php', // URL to upload script
